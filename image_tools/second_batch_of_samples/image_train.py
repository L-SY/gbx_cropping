...
class TextureAwareRegressor(nn.Module):
    """纹理感知回归模型，支持多种骨干网络"""
    def __init__(self, backbone='resnet34', pretrained=True, initial_value=15.0):
...
def main():
    ...
    # 创建模型
    model = TextureAwareRegressor(backbone=backbone, pretrained=True, initial_value=15.0)
